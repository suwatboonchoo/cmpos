...
class Shop extends Component {
            ...
            <tr>
              <td className="td_orderline">
                ...
                <div>
                  ...
                  <br />
                  {item.qty} pcs.
                  <span style={{marginTop: 39, marginRight: 20, float: 'right'}} onClick={()=>this.props.removeOrder(item)} >
                    <i className="fa fa-fw fa-trash" style={{fontSize:20}}></i>
                  </span>
                </div>
              </td>
            </tr>
  ...
  isSelectedItem = (item) => {
    const{mOrderLines} = this.props.shopReducer
    return mOrderLines.indexOf(item) != -1
  }
       ...
       { result != null && result.map((item, i) => (
        ...
        >
          <div className="card">
            ...
            <span className={this.isSelectedItem(item) ? 'nprice_tag_selected' : 'nprice_tag'} >
          ...
          <div className="row">
            <div className="col-md-4">
              <div style={{ maxWidth: "100%" }}>
                ...
                >
                  {this.props.shopReducer.mOrderLines.length > 0 ? this.renderOrderRows() : 
                  (
                    <img alt="to be done"
                ...
                <div className="card">
                  <div style={{ paddingTop: 16 }}>
                    ...
                    <button
                     disabled={!(this.props.shopReducer.mTotalPrice > 0) && !this.props.shopReducer.mIsPaymentMade}
            ...
            {this.props.shopReducer.mIsPaymentMade ? this.renderPayment() : this.renderProductRows()}
...
const mapStateToProps = ({shopReducer, stockReducer}) => ({
  shopReducer,
  stockReducer
})
